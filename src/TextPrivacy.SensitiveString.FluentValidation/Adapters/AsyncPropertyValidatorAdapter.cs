...
internal class AsyncPropertyValidatorAdapter<TRequest>(IAsyncPropertyValidator<TRequest, string> validator) : PropertyValidatorAdapter(validator),
    IAsyncPropertyValidator<TRequest, SensitiveString>
{
